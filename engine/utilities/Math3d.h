...
CT_ENGINE_API_HOT ctVec3 ctVec3Zero();

/*! @brief Construct a vector from XYZ */
CT_ENGINE_API_HOT ctVec3 ctVec3Make(float x, float y, float z);

/*! @brief Construct a (1, 1, 1) vector */
CT_ENGINE_API_HOT ctVec3 ctVec3Identity();

/*! @brief Construct a vector from a float triplet pointer */
CT_ENGINE_API_HOT ctVec3 ctVec3FromFloat3(const float data[3]);

/*! @brief Construct a vector filled with a single value */
CT_ENGINE_API_HOT ctVec3 ctVec3FromFloat(float value);

/*! @brief Is this vector approximately equal to another */
CT_ENGINE_API_HOT bool ctVec3ApproxEqual(const ctVec3 a, const ctVec3 b);

/*! @brief Add another vector to this vector */
CT_ENGINE_API_HOT void ctVec3Add(ctVec3* a, const ctVec3 b);

/*! @brief Subtract another vector from this vector */
CT_ENGINE_API_HOT void ctVec3Sub(ctVec3* a, const ctVec3 b);

/*! @brief Invert this vector's component's signs */
CT_ENGINE_API_HOT void ctVec3Negate(ctVec3* v);

/*! @brief Multiply this vector by another vector */
CT_ENGINE_API_HOT void ctVec3Mult(ctVec3* a, const ctVec3 b);

/*! @brief Multiply this vector by a float */
CT_ENGINE_API_HOT void ctVec3Scale(ctVec3* a, const float b);

/*! @brief Divide this vector by another vector */
CT_ENGINE_API_HOT void ctVec3Divide(ctVec3* a, const ctVec3 b);

/*! @brief Divide this vector by a float */
CT_ENGINE_API_HOT void ctVec3DivideFloat(ctVec3* a, const float b);

/*! @brief Get a dot product between two vectors */
CT_ENGINE_API_HOT float ctVec3Dot(const ctVec3 a, const ctVec3 b);

/*! @brief Get the distance between two vectors */
CT_ENGINE_API_HOT float ctVec3Distance(const ctVec3 a, const ctVec3 b);

/*! @brief Get the length (magnitude) of a vector */
CT_ENGINE_API_HOT float ctVec3Length(const ctVec3 v);

/*! @brief Make this vector's components positive */
CT_ENGINE_API_HOT void ctVec3Abs(ctVec3* v);

/*! @brief Make this vector a unit length vector */
CT_ENGINE_API_HOT void ctVec3Normalize(ctVec3* v);

/*! @brief Clamp this vector from 0-1 */
CT_ENGINE_API_HOT void ctVec3Saturate(ctVec3* v);

/*! @brief Fill this vector with the cross product between two vectors */
CT_ENGINE_API_HOT void ctVec3Cross(ctVec3* out, const ctVec3 a, const ctVec3 b);

/*! @brief Fill this vector with the lerp result between two vectors */
CT_ENGINE_API_HOT void
ctVec3Lerp(ctVec3* out, const ctVec3 a, const ctVec3 b, const float t);
...
CT_ENGINE_API_HOT ctQuat ctQuatIdentity();

/*! @brief Construct a quaternion from a float pointer to 4 values */
CT_ENGINE_API_HOT ctQuat ctQuatFromFloat4(const float v[4]);

/*! @brief Construct a quaternion that represents a rotation around an axis */
CT_ENGINE_API_HOT ctQuat ctQuatFromAxisAngle(const ctVec3 axis, float angle);

/*! @brief Construct a quaternion from a euler rotation */
CT_ENGINE_API_HOT ctQuat ctQuatFromEuler(const ctVec3 euler);

/*! @brief Rotate this quaternion by another quaternion */
CT_ENGINE_API_HOT void ctQuatRotate(ctQuat* a, const ctQuat b);

/*! @brief Invert the rotation of this quaternion */
CT_ENGINE_API_HOT void ctQuatInvert(ctQuat* v);

/*! @brief Fix any issues in this quaternion */
CT_ENGINE_API_HOT void ctQuatNormalize(ctQuat* v);

/*! @brief Rotate a vector by a given quaternion */
CT_ENGINE_API_HOT void ctQuatRotateVec3(ctVec3* vector, const ctQuat q);

/*! @brief Get the forward vector of this quaternion */
CT_ENGINE_API_HOT ctVec3 ctQuatGetForward(const ctQuat q);

/*! @brief Get the back vector of this quaternion */
CT_ENGINE_API_HOT ctVec3 ctQuatGetBack(const ctQuat q);

/*! @brief Get the up vector of this quaternion */
CT_ENGINE_API_HOT ctVec3 ctQuatGetUp(const ctQuat q);

/*! @brief Get the down vector of this quaternion */
CT_ENGINE_API_HOT ctVec3 ctQuatGetDown(const ctQuat q);

/*! @brief Get the right vector of this quaternion */
CT_ENGINE_API_HOT ctVec3 ctQuatGetRight(const ctQuat q);

/*! @brief Get the left vector of this quaternion */
CT_ENGINE_API_HOT ctVec3 ctQuatGetLeft(const ctQuat q);

/*! @brief Construct a quaternion that looks at a target from a given orientation */
CT_ENGINE_API_HOT ctQuat ctQuatLookAt(const ctVec3 direction,
                                      const ctVec3 forward,
                                      const ctVec3 up);

/*! @brief Construct a quaternion that takes part of the shortest path on a sphere between
 * two rotations */
CT_ENGINE_API_HOT void ctQuatSlerp(ctQuat* dest, const ctQuat a, const ctQuat b, float t);
...
CT_ENGINE_API_HOT ctColorRGBA8 ctColorRGBA8FromFloat4(float input[4]);

/*! @brief Convert vector representing rgb into a color with a given alpha */
CT_ENGINE_API_HOT ctColorRGBA8 ctColorRGBA8FromVec3(const ctVec3 rgb, const float a);